...
public class BlackPlayer extends Player {
    ...
    protected Collection<Move> calculateKingCastles(Collection<Move> playerLegalMoves, Collection<Move> opponentLegalMoves) {
        ...
        if (this.playerKing.isFirstMove() && !this.getIsInCheck()) {
            ...
            Tile tile5 = board.getTile(new BoardPosition(5, 7));
            Tile tile6 = board.getTile(new BoardPosition(6, 7));
            Tile rookTileKingSide = board.getTile(new BoardPosition(7, 7));
            ...
            if (!tile5.isTileOccupied() && !tile6.isTileOccupied() &&
                ...
                kingCastles.add(new Move.KingSideCastleMove(this.board, this.getPlayerKing(), new BoardPosition(6, 7)));
            }

            // Queen-side castling (long castling)
            Tile tile3 = board.getTile(new BoardPosition(3, 7));
            Tile tile2 = board.getTile(new BoardPosition(2, 7));
            Tile tile1 = board.getTile(new BoardPosition(1, 7));
            Tile rookTileQueenSide = board.getTile(new BoardPosition(0, 7));
            ...
            if (!tile3.isTileOccupied() && !tile2.isTileOccupied() && !tile1.isTileOccupied() &&
                ...
                kingCastles.add(new Move.QueenSideCastleMove(this.board, this.getPlayerKing(), new BoardPosition(2, 7)));
            }
        }
